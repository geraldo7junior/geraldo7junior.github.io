...
includeScript ('../booking/js/jquery-ui-1.10.3.custom.min.html');
includeScript ('../booking/js/jquery.fancyform.html');
includeScript ('../booking/js/jquery.placeholder.html');
includeScript ('../booking/js/regula.html');
